...
class PeerConnectionV2 extends StateMachine {
  ...
  constructor(id, encodingParameters, preferredCodecs, options) {
    ...
    peerConnection.offer = this._offer.bind(this);
    peerConnection.answer = this._answer.bind(this);
  ...
  _offer() {
    ...
    const getPromiseAnswer = () => new Promise((resolve) => {
      return this._peerConnection.createOffer((answer) => resolve(answer), (error) => error), { mandatory: {OfferToReceiveAudio: true, OfferToReceiveVideo: true }}
    });
