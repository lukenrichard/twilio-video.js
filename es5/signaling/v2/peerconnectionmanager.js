...
var PeerConnectionManager = /** @class */ (function (_super) {
    ...
    PeerConnectionManager.prototype._getOrCreate = function (id, configuration) {
        ...
        if (!peerConnection) {
            ...
            actualPeerConnection = peerConnection_1._peerConnection;
            ...
            actualPeerConnection.onicegatheringstatechange = function (event) {
            ...
            //3-1-5:
            actualPeerConnection.oniceconnectionstatechange = function (event) {
