...
var PeerConnectionV2 = /** @class */ (function (_super) {
    ...
    function PeerConnectionV2(id, encodingParameters, preferredCodecs, options) {
        ...
        var twilIce = configuration === null || configuration === void 0 ? void 0 : configuration.iceServers;
        var citrixConfiguration = {
            iceServers: twilIce,
            enableDtlsSrtp: true
        };
        ...
        peerConnection.onconnectionstatechange = _this._handleConnectionStateChange.bind(_this);
        peerConnection.ondatachannel = _this._handleDataChannelEvent.bind(_this);
    ...
    PeerConnectionV2.prototype._offer = function () {
        ...
        return Promise.all(this._replaceTrackPromises.values())
            .then(function () {
            _this._peerConnection.createOffer(function (offer) {
                console.log('banana is this getting called?', _this._peerConnection);
                if (isFirefox) {
                    // NOTE(mmalavalli): We work around Chromium bug 1106157 by disabling
                    // RTX in Firefox 79+. For more details about the bug, please go here:
                    // https://bugs.chromium.org/p/chromium/issues/detail?id=1106157
    ...
    PeerConnectionV2.prototype._setLocalDescription = function (description) {
        var _this = this;
        console.log('banana does this get called?', description);
    ...
    PeerConnectionV2.prototype.addMediaTrackSender = function (mediaTrackSender) {
        ...
        //   return;
        // }
        // console.log('banana sender', mediaTrackSender);
