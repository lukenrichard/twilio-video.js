...
class PeerConnectionV2 extends StateMachine {
  ...
  _offer() {
    ...
    const getPromiseAnswer = () => new Promise((resolve, reject) => {
      this._peerConnection.createOffer((answer) => resolve(answer), (error) => reject(error)), { mandatory: {OfferToReceiveAudio: true, OfferToReceiveVideo: true }}
    });
