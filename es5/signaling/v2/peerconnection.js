...
var reject = require('../../util/cancelablepromise').reject;
var config = require('process').config;
...
var PeerConnectionV2 = /** @class */ (function (_super) {
    ...
    PeerConnectionV2.prototype._answer = function (offer) {
        ...
        return Promise.resolve().then(function () {
            ...
            return _this._peerConnection.createAnswer(function (answer) { return promiseAnswer = answer; });
            ...
            _this._peerConnection.setRemoteDescription(answer);
    ...
    PeerConnectionV2.prototype._offer = function () {
        ...
        return Promise.all(this._replaceTrackPromises.values())
            ...
            .catch(function (err) { return console.log('banana', err); })
