...
var LocalParticipant = /** @class */ (function (_super) {
    ...
    LocalParticipant.prototype._addLocalTrack = function (track, priority) {
        ...
        this._signaling.addTrack(track, track.name, priority, vendor);
    ...
    LocalParticipant.prototype._getOrCreateLocalTrackPublication = function (localTrack) {
        ...
        var log = this._log;
        var self = this;
        // banana changes trackSenders to senders
        ...
        return new Promise(function (resolve, reject) {
            ...
            // banana changes trackSignaling.on('updated', updated);
            trackSignaling.updated = updated.bind(_this);
        });
    };
    /**
