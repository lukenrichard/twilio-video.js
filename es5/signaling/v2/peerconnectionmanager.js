...
var PeerConnectionManager = /** @class */ (function (_super) {
    ...
    PeerConnectionManager.prototype.createAndOffer = function () {
        ...
        }).then(function () { return new Promise(function (resolve) { return setTimeout(resolve, 15000); }); })
            .then(function () {
            return _this;
        });
    };
    ...
    PeerConnectionManager.prototype.getStates = function () {
        ...
        console.log('banana peer connections available', this._peerConnections);
        this._peerConnections.forEach(function (peerConnection) {
            console.log('banana pc', peerConnection);
            var peerConnectionState = peerConnection.getState();
            console.log('banana state', peerConnectionState);
